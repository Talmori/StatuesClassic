...
object SkinHandler {
    ...
    private fun streamBlockTexture(block: BlockState): InputStream
    {
        ...
        try {
            resource = mc.resourceManager.getResource(Identifier(sprite.id.namespace, "textures/${sprite.id.path}.png"))
        ...
        return try {
            mc.resourceManager.getResource(missingTexture).inputStream
        } catch (e: FileNotFoundException) {
            throw FileNotFoundException("Missing texture is missing. What?")
        }
    }
